      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
          <DialogTrigger render={
            <Button className="bg-income hover:bg-income/90 text-white font-bold h-10 px-4 gap-1.5 shadow-xs transition-all active:scale-95 duration-150 cursor-pointer">
        ...
        <div className="space-y-4">
          <Card className="shadow-xs border-border bg-card hover:shadow-md transition-all duration-300">
            <CardHeader className="pb-4 pt-6 px-6">
              ...
              <CardDescription className="text-xs">Lista cronológica de receitas cadastradas</CardDescription>
            </CardHeader>
