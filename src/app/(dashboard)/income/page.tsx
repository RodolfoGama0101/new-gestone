        ...
        <div className="space-y-4">
          <Card className="border-border bg-card shadow-xs hover:shadow-sm transition-all duration-200 rounded-md">
            <CardHeader className="pb-2 pt-4 px-5">
              ...
              <CardDescription className="text-[10px] text-muted-foreground">Lista cronológica de receitas cadastradas</CardDescription>
            </CardHeader>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-6 shrink-0">
                      <span className="text-xs sm:text-sm font-semibold text-green-700 dark:text-green-500">
